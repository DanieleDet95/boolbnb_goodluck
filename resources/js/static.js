...
if($('#bar_visual').length) {
  ...
  function printStatics(){
    ...
    // Chiamata ajax per le statistiche
    $.ajax({
        ...
        success: function(dataResponse) {
          ...
          // Stampa delle visite/messaggi totali sulla view
          $('#vis_totali').html(dataResponse.v_totale);
          $('#mess_totali').html(dataResponse.m_totale);


          // Implementazione variabili per mesi
          ...
          // Implementazione schema della statistica Visualizzazioni
          ...
          var myChart = new Chart(ctx, {
            ...
            // Implementazione schema della statistica messaggi
